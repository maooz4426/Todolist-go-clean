...
// Source: domain/persistence/transaction_manager.go
//
// Generated by this command:
//
//	mockgen -source=domain/persistence/transaction_manager.go -destination=domain/mockreposiotry/transaction_manager.go -package mockrepository
//
